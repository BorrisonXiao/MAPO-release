...
if __name__ == "__main__":
    ...
    parser.add_argument('-i', '--input', type=str, required=True, help='Path to input JSON file to be evaluated')
    parser.add_argument('-o', '--output', type=str, required=True, help='Path to output JSON file with results')
    ...
    report = {
        ...
        "metric_groups": {
            "modality": build_group(modality_metrics),
